...
<body>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <div class="loading-text" style="color: green; font-weight: bold;">
    TEBRİKLER<br><span class="loading-dots"></span>
</div>

            <br><br>
            <img src="https://cdn-icons-png.freepik.com/512/6784/6784655.png" width="170px" height="170px" alt="Bekleyiniz" width="50px">
            <br><br>
            <div class="info-text">
                 Başvurunuz Tamamlandı<br>Müşteri Temsilcimiz En Kısa Sürede Tarafınıza Dönüş Yapacaktır.
            </div>
        </div>
    </div>
